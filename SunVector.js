...
function run(Latitude, Day, Hour, South) {
...
NSolar.prototype.GetSunLine = function(){
    var v0 = modeling.entities.point([this.VectorSun.x, this.VectorSun.y, this.VectorSun.z]);
    var v1 = modeling.entities.point([0, 0, 0]);
    return modeling.entities.line(v0, v1);
};
NSolar.prototype.GetSunVector = function(){
    return modeling.entities.point([this.VectorSun.x, this.VectorSun.y, this.VectorSun.z]);
};
